            ...
            <Grid container justify="space-between" alignItems="center" >
                ...
                <Grid item container spacing={2} style={{ paddingTop: '1rem' }}>
                    <Grid item xs={12} md={6} style={{ textAlign: 'center' }}>
                        ...
                        <Grid container alignContent='flex-start' alignItems='flex-start' spacing={2} style={{ marginTop: '2.25rem' }}>
                            <Grid item className={classes.phone}>
                                <LocalPhoneRoundedIcon />
                            </Grid>
                            <Grid item>
                                <Typography variant="h6" color="textSecondary" component="a" href="tel:+38 095 113 85 98" className={classes.link}>
                                    +38 095 123 45 67
                                </Typography>
                            </Grid>
                        </Grid>
                        <Grid container alignContent='flex-start' alignItems='flex-start' spacing={2} style={{ marginTop: '1rem' }}>
                            <Grid item className={classes.phone}>
                                <a href="/" target="_blank" rel="noopener noreferrer">
                                    <img src={vbr} alt="viber" width='28' height='28' />
                                </a>
                            </Grid>
                            <Grid item>
                                <a href="/" target="_blank" rel="noopener noreferrer">
                                    <img src={tlg} alt="telegram" width='28' height='28' />
                                </a>
                            </Grid>
                        </Grid>
                    </Grid>
